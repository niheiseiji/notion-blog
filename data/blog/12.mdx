...
=======
![1000001936.jpg](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1766366189304_tchnrpthzcl.jpg)
>>>>>>> 7a31085 (refactor: replace sortPosts utility with sortPostsBySort for consistent post sorting and update contentlayer configuration to include sort field)
...
=======
![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1766366190109_aeo8zqmrkrq.png)

とりあえずこんなDBを作ってみた

![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1766366190690_7jp1vrlgn9c.png)

テスト用の個別のページはタイトルとその他プロパティ、本文で構成してみた。本文にはいくつかの種類のタグを用意してみた。

![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1766366191218_y2262smczm.png)
>>>>>>> 7a31085 (refactor: replace sortPosts utility with sortPostsBySort for consistent post sorting and update contentlayer configuration to include sort field)
...
=======
![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1766366192124_arsacglmcv.png)
>>>>>>> 7a31085 (refactor: replace sortPosts utility with sortPostsBySort for consistent post sorting and update contentlayer configuration to include sort field)
