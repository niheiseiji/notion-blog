...
authors: ['nihei-seiji']
layout: 'PostSimple'
summary: "Notionをインターフェースにしたブログの実装。"
---
...
![1000001936.jpg](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1765974072010_zj1wof1yq78.jpg)
...
![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1765974073322_xg82fyfqtjd.png)


とりあえずこんなDBを作ってみた


![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1765974073856_catqy2pltzm.png)


テスト用の個別のページはタイトルとその他プロパティ、本文で構成してみた。本文にはいくつかの種類のタグを用意してみた。


![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1765974074262_jdc5yibboi.png)
...
![image.png](https://pub-b95f33ff68ca4b8fb78cd87d8d40206f.r2.dev/notion-images/notion_1765974075034_bivmcnczm9s.png)
